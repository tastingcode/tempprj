package taco.board.hotarticle.service;
...
import taco.board.hotarticle.service.eventhandler.EventHandler;
...
public class HotArticleScoreUpdater {
	...
	public void update(Event<EventPayload> event, EventHandler<EventPayload> eventHandler) {
		...
		hotArticleListRepository.add(
				articleId, createdTime, score, HOT_ARTICLE_COUNT, HOT_ARTICLE_TTL
				);
	}
