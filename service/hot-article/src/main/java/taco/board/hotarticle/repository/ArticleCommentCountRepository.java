package taco.board.hotarticle.repository;
...
public class ArticleCommentCountRepository {
	...
	// hot-article::article::{article_id}::comment-count
	...
	public void createOrUpdate(Long articleId, Long commentCount, Duration ttl){
		redisTemplate.opsForValue().set(generateKey(articleId), String.valueOf(articleId), ttl);
	}
